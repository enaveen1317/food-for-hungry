...
const Emergency = () => {
  ...
  return (
    <div style={{ background: '#FFF5F5', fontFamily: "'Inter','Poppins',sans-serif", paddingTop: '20px', minHeight: '100vh' }}>
      <div className="container" style={{ maxWidth: '100%', margin: '0 auto', paddingBottom: '40px' }}>
        <style>{`
